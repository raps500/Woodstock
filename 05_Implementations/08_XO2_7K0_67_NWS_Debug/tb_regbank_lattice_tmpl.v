//Verilog testbench template generated by SCUBA Diamond (64-bit) 3.6.0.83.4
`timescale 1 ns / 1 ps
module tb;
    reg [3:0] DataInA = 4'b0;
    reg [3:0] DataInB = 4'b0;
    ...
    regbank_lattice u1 (.DataInA(DataInA), .DataInB(DataInB), .AddressA(AddressA), 
